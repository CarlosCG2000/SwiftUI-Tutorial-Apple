...
struct LandmarkList: View {
    ...
    @Environment(ModelData.self) var modelData // permite que la vista `LandmarkList` acceda a datos globales sin pasarlos como parámetros. Sirve para reconocer el tipo de datos y buscar una instancia de ese tipo en el entorno de la vista.
